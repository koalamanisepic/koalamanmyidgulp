...
$canonicalPath = '';
$papersCount = count(papers_index_read());
$papersUnit = $papersCount === 1 ? 'unit_singular' : 'unit';
      ...
      <ol>
        ...
        <li>
          <a href="#papers">
            ...
            <span class="index-name"><?= htmlspecialchars($t['papers_home']['label']) ?></span>
            <span class="index-count"><?= $papersCount ?> <?= htmlspecialchars($t['papers_home'][$papersUnit]) ?></span>
          </a>
        </li>
      </ol>
    </nav>
...
<!-- Papers ====================================================== -->
<section class="section reveal" id="papers">
  <div class="wrap">
    <div class="section-head">
      <div>
        <span class="section-label"><?= htmlspecialchars($t['papers_home']['label']) ?></span>
        <h2 class="section-title"><?= htmlspecialchars($t['papers_home']['title']) ?></h2>
      </div>
      <p class="section-desc"><?= htmlspecialchars($t['papers_home']['desc']) ?></p>
    </div>

    <article class="card">
      <span class="card-code"><?= $papersCount ?> <?= htmlspecialchars($t['papers_home'][$papersUnit]) ?></span>
      <h3 class="card-title"><?= htmlspecialchars($t['papers_home']['title']) ?></h3>
      <p class="card-desc"><?= htmlspecialchars($t['papers_home']['desc']) ?></p>
      <a class="card-link" href="<?= htmlspecialchars(with_lang($t['papers_home']['link'], $lang)) ?>">
        <?= htmlspecialchars($t['papers_home']['cta']) ?>
        <span class="btn-arrow" aria-hidden="true">→</span>
      </a>
    </article>
  </div>
